...
def executar(input_dir: Path = INPUT_DIR,
    ...
    dim_grupo_insumo = pd.read_excel(r'C:\Users\kaua.rodrigo\Documents\etl_sienge\stages\transform\input\reference\auxiliar_grupo_insumo_luis.xlsx')  # colocar a planilha enviada pelo luis
